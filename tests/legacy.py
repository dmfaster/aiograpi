...
class AuthAndStoryRegressionTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_login_two_factor_invalid_parameters_falls_back_to_bloks_when_context_available(self):
        ...
        self.assertTrue(result)
        self.assertEqual(client.private_request.call_count, 2)
        client.bloks_two_step_verification_entrypoint.assert_awaited_once_with("context-1")
        client.bloks_two_step_verification_method_picker.assert_awaited_once_with("context-1")
